...
def main():
    ...
    ap.add_argument("--tie-embeddings", dest="tie_embeddings", action="store_true")
    ap.add_argument("--no-tie-embeddings", dest="tie_embeddings", action="store_false")
    ap.set_defaults(tie_embeddings=True)
    ...
    # New GradScaler API (avoid deprecation warning)
